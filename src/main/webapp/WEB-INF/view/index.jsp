...
<HEAD>
  <TITLE>insert data using prepared statement </TITLE>
	...
	<a href="googlechrome://navigate?url=youtube.com">chrome</a>
		<a href="https://www.youtube.com/results?search_query=mzeks+mane">you</a>
    <BODY bgcolor="#ffffcc">
...
<%
   ...
   format with machine name, 
    ...
    String connectionURL = "jdbc:mysql://sql4.freesqldatabase.com:3306/sql4438606";
    ...
    //executing sql statements.
	 ...
	 if(name!=null && city!=null && phone!=null){
		...
		to database. */
              ...
              (connectionURL, "sql4438606", "uSFMq5B9hF");
